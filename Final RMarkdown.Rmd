---
title: "BIOL 806: Final Project <br> Movement Patterns of Rainbow Smelt in Great Bay Estuary, NH"
...
# Methods
```{Map 1,echo=FALSE,eval=T, tidy=TRUE}
require(dplyr)
library(dplyr)
library(sp)
library(maptools)
...
```{Map 2,echo=FALSE,eval=T, tidy=TRUE}
...
```{Annimation 1,echo=FALSE,eval=T, tidy=TRUE}
```
<br>
...
```{Annimation 2,echo=FALSE,eval=T, tidy=TRUE}
```
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The second animation shows a female tagged in the Squamscott River (tag ID #53774) (Fig. 4). 

```{Annimation 3,echo=FALSE,eval=T, tidy=TRUE}
```
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The third animation shows a male tagged in the Oyster River (tag ID #53801) (Fig. 5). 

ADD MORE ABOU FINAL FIGURE??
